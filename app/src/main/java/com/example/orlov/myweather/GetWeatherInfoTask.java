package com.example.orlov.myweather;
...
public class GetWeatherInfoTask extends AsyncTask<String,Void,List<Map<String,Object>>> {
    ...
    protected void onPostExecute(List<Map<String, Object>> result) {
        ...
        if (result.size()>0){
            ...
            SimpleAdapter simpleAdapter = new SimpleAdapter(context,result,R.layout.weather_item,new String[]{"temprature","weather","date","week","weather_icon"},new int[]{R.id.temperature,R.id.weather,R.id.date,R.id.week,R.id.weather_icon});
        ...
        try {
            ...
            if (response.getStatusLine().getStatusCode()==200){
                ...
                if (jsondata.getInt("resultcode")==200){
                    ...
                    erroMsg="非常抱歉，本应用暂不支持您所请求的城市！！";
                }
            }else {
                erroMsg="网络错误，请检查手机是否开启了网络";
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
